...
const dict: Dict = {
  en: {
    ...
    mbtaNearYou: "Stops & stations near the map center — routes and lines listed under each",
    ...
    mbtaRoutesLabel: "Routes & lines",
    mbtaVehicleTram: "Green Line / light rail",
    mbtaVehicleSubway: "Subway",
    mbtaVehicleRail: "Commuter rail",
    mbtaVehicleBus: "Bus",
    mbtaVehicleFerry: "Ferry",
    mbtaVehicleOther: "Transit",
    mapSectionTitle: "Map",
  ...
  es: {
    ...
    mbtaNearYou: "Paradas y estaciones cerca del centro del mapa — rutas debajo de cada una",
    ...
    mbtaRoutesLabel: "Rutas y líneas",
    mbtaVehicleTram: "Green Line / tranvía",
    mbtaVehicleSubway: "Metro (subway)",
    mbtaVehicleRail: "Tren de cercanías",
    mbtaVehicleBus: "Autobús",
    mbtaVehicleFerry: "Ferry",
    mbtaVehicleOther: "Transporte",
  ...
  ht: {
    ...
    mbtaNearYou: "Estasyon toupre sant kat la — wout ki pase anba chak non",
    ...
    mbtaRoutesLabel: "Wout ak liy",
    mbtaVehicleTram: "Green Line / tramvay",
    mbtaVehicleSubway: "Metro (subway)",
    mbtaVehicleRail: "Tren gran distans",
    mbtaVehicleBus: "Bis",
    mbtaVehicleFerry: "Bato",
    mbtaVehicleOther: "Transpò",
    mapSectionTitle: "Kat",
  ...
  zh: {
    ...
    allPins: "显示地图上全部点",
    mbtaNearYou: "地图中心附近的站点 — 各站下列出经过的线路",
    mbtaPlanTrip: "行程规划（mbta.com）",
    mbtaAreaHaymarket: "Haymarket 一带",
    mbtaAreaGovt: "Government Center 与市中心",
    mbtaAreaOther: "其他附近站点",
    mbtaRoutesLabel: "线路",
    mbtaVehicleTram: "绿线 / 轻轨",
    mbtaVehicleSubway: "地铁",
    mbtaVehicleRail: "通勤铁路",
    mbtaVehicleBus: "公交",
    mbtaVehicleFerry: "轮渡",
    mbtaVehicleOther: "公共交通",
    mapSectionTitle: "地图",
  ...
  pt: {
    ...
    mbtaNearYou: "Paradas e estações perto do centro do mapa — rotas listadas abaixo de cada uma",
    ...
    mbtaRoutesLabel: "Rotas e linhas",
    mbtaVehicleTram: "Green Line / VLT",
    mbtaVehicleSubway: "Metrô (subway)",
    mbtaVehicleRail: "Trem regional",
    mbtaVehicleBus: "Ônibus",
    mbtaVehicleFerry: "Balsa",
    mbtaVehicleOther: "Transporte",
    mapSectionTitle: "Mapa",
